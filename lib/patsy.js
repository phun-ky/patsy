  ...
  return {
    ...
    load : function(config){
      ...
      if(typeof config !== 'undefined' && typeof config === 'object'){
        ...
        if(opts.verbose || config.options.verbose || config.proxy.options.verbose || false){
          util.print('>>'.cyan + ' Changing directory to : ' + opts.app_path);
        }
        ...
        try{
          ...
          console.trace();
          console.log('>> FAIL'.red + ': Could not change directory!',e);
        }
    ...
    loadGrunt : function(config){
      ...
      this.grunt     = spawn(_bin, _newArgs, { stdio: 'inherit' });
    ...
    setup : function(){
      ...
      if(typeof this.project_cfg.project.options !== 'undefined' && this.project_cfg.project.options.watch_config){
        ...
        if(opts.verbose){
          ...
          util.print('>>'.cyan + ' Watching project configuration file: '.white + path.resolve('patsy.json').cyan + '...');
