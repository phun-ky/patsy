    ...
    load : function(patsy, project_path){
      ...
      if(typeof project_path === 'undefined'){        
        ...
        if(opts.verbose){
          ...
          util.print('>>'.yellow + ' No project path set, declaring path to CWD: '.white + String(process.cwd() + path.sep).inverse.cyan + '');
      ...
      if(opts.verbose){
        ...
        util.print('\n>>'.cyan + ' Reading project configuration file: ' + _path_to_config.inverse.cyan + '...\n');
      ...
      if(!fs.existsSync(_path_to_config)){
        ...
        if(opts.verbose){
          util.print('\n>>'.yellow + ' Configuration file not found here, looking elsewhere: ' + _path_to_config.inverse.cyan + '...\n');
        }
