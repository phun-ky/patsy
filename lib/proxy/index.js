    ...
    start  : function(cfg){
      ...
      try{
        ...
        httpProxy.createServer(function (req, res, proxy) {
          ...
          util.print('[Proxy]:'.magenta + ' Setting up route for ' + req.url + '...');
          ...
          if(_opts && gotMatch){
            ...
            util.print('[Proxy]:'.magenta + ' Guiding ' + req.url + ' to ' + _route.host + ':' + _route.port  +'...');
            ...
            try{
              util.print("WARN\n".yellow);
              util.print('>>'.yellow + ' No match found, relaying to ' + cfg.project.environment.host + req.url + '...');
              _route =  {
